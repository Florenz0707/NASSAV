    ...
    return [
      {
        ...
        action: 'delete',
        title: '删除数据',
        message: '确定要删除该资源的元数据和封面吗？此操作不可恢复！',
      },
    ]
  }
})
...
const displayedTitle = computed(() => {
  ...
  return (
    resource.source_title || resource.translated_title || resource.original_title || resource.avid
  )
})
...
async function jumpPlay() {
  try {
    ...
    if (!path) toastStore.error('未返回文件路径')
...
<template>
  <div class="animate-[fadeIn_0.5s_ease]">
    ...
    <div v-else-if="error" class="text-center py-16 px-8">
      ...
      <h2 class="text-xl text-[var(--text-primary)] mb-2">加载失败</h2>
    ...
    <template v-else-if="metadata">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-[400px_1fr] gap-10 mb-12">
          ...
          <div class="flex justify-between gap-3">
            ...
            >
              ...
              <span
                ...
                :class="
                  metadata.is_favorite ? 'text-[var(--accent-primary)]' : 'text-[var(--text-muted)]'
                "
              >
            ...
            >
              ...
              <span
                class="text-sm font-medium"
                :class="
                  metadata.watched ? 'text-[var(--accent-success)]' : 'text-[var(--text-muted)]'
                "
              >
        ...
        <div class="flex flex-col justify-center">
          ...
          <div class="grid grid-cols-2 gap-4 mb-2.5">
            ...
            <div
              class="inline-block px-3.5 py-1.5 rounded-md font-['JetBrains_Mono',monospace] text-[0.9rem] font-semibold w-fit"
              :class="
          ...
          <div class="grid grid-cols-2 gap-4 mb-8">
            <div v-if="metadata.release_date" class="flex flex-col gap-1">
              <span class="text-[0.8rem] text-[var(--text-muted)] uppercase tracking-wider"
                >发行日期</span
              >
            ...
            <div class="flex flex-col gap-1">
              <span class="text-[0.8rem] text-[var(--text-muted)] uppercase tracking-wider"
                >来源</span
              >
              <span class="text-base text-[var(--accent-secondary)] font-medium">{{
                metadata.source
              }}</span>
            </div>
          ...
          <div class="flex flex-wrap gap-4">
            ...
            <div class="relative" @click.stop>
              ...
              <!-- 刷新下拉菜单 -->
              <div
                v-if="showRefreshMenu && !refreshing"
      ...
      <div class="flex flex-col gap-8">
        ...
        >
          <h2
            class="text-[1.1rem] font-semibold text-[var(--text-primary)] mb-5 pb-3"
              ...
              <div class="text-[0.95rem] text-[var(--text-primary)] flex flex-wrap gap-2">
                ...
                >
                  {{ actor
                    ...
                    v-if="index < metadata.actors.length - 1"
                    class="text-[var(--text-muted)] ml-1"
                    >,</span
                  >
                </button>
              </div>
              ...
              <div class="text-[0.95rem] text-[var(--text-primary)] flex flex-wrap gap-2">
                ...
                >
                  {{ genre
                    ...
                    v-if="index < metadata.genres.length - 1"
                    class="text-[var(--text-muted)] ml-1"
                    >,</span
                  >
                </button>
