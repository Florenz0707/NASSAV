...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('nassav', '0003_rename_nassav_avre_avid_idx_nassav_avre_avid_fcdb07_idx_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['metadata_saved_at'], name='nassav_avre_metadata_saved_at_idx'),
        ),
        ...
        migrations.RunSQL(
            ...
            reverse_sql=(
                "DROP INDEX IF EXISTS nassav_avresource_actors_actor_id_idx;"
            ),
        ),
    ]
