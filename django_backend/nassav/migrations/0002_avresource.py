    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_date', models.CharField(blank=True, max_length=64, db_index=True)),
                ('duration', models.IntegerField(blank=True, help_text='时长（秒）', null=True)),
                ('metadata', models.JSONField(blank=True, null=True)),
                ('m3u8', models.TextField(blank=True, null=True)),
                ('cover_filename', models.CharField(blank=True, help_text='相对于 resource/{avid}/ 的封面文件名', max_length=255, null=True)),
                ('file_exists', models.BooleanField(default=False, db_index=True, help_text='是否存在 MP4 文件')),
        ...
        migrations.AddField(
            model_name='avresource',
            name='actors',
            field=models.ManyToManyField(blank=True, related_name='resources', to='nassav.actor'),
        ),
        migrations.AddField(
            model_name='avresource',
            name='genres',
            field=models.ManyToManyField(blank=True, related_name='resources', to='nassav.genre'),
        ),
    ]
