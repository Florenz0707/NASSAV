...
![首页](vue_frontend/public/home.png)

### 资源库
支持按 AVID/标题/来源搜索，按状态过滤，按日期/编号/来源排序，提供批量操作。

![资源库](vue_frontend/public/resource.png)

### 资源详情
展示完整的元数据信息，包括封面、演员、类别、文件大小等，支持下载和刷新操作。

![资源详情](vue_frontend/public/resourceDetail.png)

### 添加资源
输入 AVID 并选择下载源，实时显示封面下载、元数据保存、信息刮削状态。

![添加资源](vue_frontend/public/addResource.png)

### 下载管理
查看已下载的资源列表，快速跳转到资源详情页。

![下载管理](vue_frontend/public/downloads.png)
